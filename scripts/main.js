...
const CLEFAPI = 'f55e5226bf41789bef44fd4150a73c4d';
let resultatsAPI;
...
// Premier appel API & retourne données en JSON
function appelAPI(long, lat) {
    ...
    .then((data) => {
        ...
        // les heures, par tranche de trois heures, avec leur temperature
